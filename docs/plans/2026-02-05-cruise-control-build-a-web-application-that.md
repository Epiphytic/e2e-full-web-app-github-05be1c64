...
```json
{
  ...
  "tasks": [
    ...
    },
    {
      ...
      "description": "Create .github/workflows/lint.yml using github/super-linter@v7 that runs on PRs to main. Configure for Rust (clippy), TypeScript (eslint), HTML, CSS, YAML, and GitHub Actions validation. Exclude node_modules and target directories.",
      "blocked_by": [],
      "complexity": "low",
      "acceptance_criteria": [
    ...
    },
    {
      ...
      "blocked_by": ["CRUISE-007", "CRUISE-011", "CRUISE-014"],
      "complexity": "medium",
      "acceptance_criteria": [
